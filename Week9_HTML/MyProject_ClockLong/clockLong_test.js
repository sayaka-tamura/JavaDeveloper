...
function myFunction(){
	...
	document.getElementById("changeTo36h").onclick = "myFunction_36h(withoutOffset);"
	document.getElementById("changeTo48h").onclick = "myFunction_48h(withoutOffset);"
...
/*-------- 36H clock ----------*/
function myFunction_36h(withoutOffset) {
	// change button color
...
function myFunction_48h(withoutOffset){
	// change button color
