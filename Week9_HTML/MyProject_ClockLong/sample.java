function secondsToString(timeInMillis)
{	
		var numyear = Math.floor(timeInMillis / 31536000); 					//ex. 1986
		console.log("Year: " + (numyear+1970));
		var numdays = Math.floor((timeInMillis % 31536000) / 86400); 		// ex. 156(days)
		console.log("Day: " + numdays);

		var daysInCurrentYear = (numdays - numberOfLeapYearsSince1970(numyear+1970)) % 365; // ex. 156(days) or 155

	var numhours = Math.floor(((timeInMillis  % 31536000) % 86400) / 3600);	// 0-24 hours expression

		if (numhours > 0) daysInCurrentYear++;
		console.log("daysInCurrentYear: " + daysInCurrentYear); 			// add today

		var currentMonthNum = getMonthFromDays(numyear, daysInCurrentYear);	// 0-12 month
		console.log("currentMonthNum: " + currentMonthNum);

		var monthName = getMonthName(currentMonthNum);						// April, May, June...
		console.log("monthName: " + monthName);

	var numminutes = Math.floor((((timeInMillis  % 31536000) % 86400) % 3600) / 60);
	var numseconds = Math.floor((((timeInMillis  % 31536000) % 86400) % 3600) % 60);
