...
public class Student {
	...
	public void putinfo(int num) {
		System.out.println("Type name for student No. [" + (num) + "]");
		this.setName(in.nextLine());
		System.out.println("Type Grade for student No. [" + (num) + "] between [A-F]");
		this.setGrade(in.nextLine());
		System.out.println("Type GPA for student No. [" + (num) + "] between 0 to 4.0");
